...
from ..loss.tactile_loss import tactile_surface_loss, TactileLossConfig
from ..render.rasterizer import render_rgbd, RenderConfig, CameraParams
...
class ObjectCentricFusion(nn.Module):
    ...
    def compute_vision_loss(self,
        ...
        from ..render.rasterizer import GaussianRasterizer, RenderConfig
