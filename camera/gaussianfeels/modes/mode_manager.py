...
class ModeManager:
    ...
    def _check_upgrade_transitions(self):
        """REMOVED: No automatic upgrades - explicit transitions only"""
        raise NotImplementedError("Automatic transitions removed. Use explicit set_mode() calls.")
    
    def _check_downgrade_transitions(self):
        """REMOVED: No automatic downgrades - fail fast instead"""
        raise NotImplementedError("Automatic transitions removed. Use explicit set_mode() calls.")
