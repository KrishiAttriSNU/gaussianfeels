...
class GaussianFeelsConfig:
    ...
    def get_sensor_config(self, modality: str) -> ModalityConfig:
        ...
        if modality == "vitac":
            sensors = [
                SensorConfig("realsense_front_left", "realsense"),
            ...
            if self.three_camera_mode:
                sensors.extend([
                    SensorConfig("realsense_front_right", "realsense"),
                    SensorConfig("realsense_top", "realsense"),
                ])
        elif modality == "vi":
            sensors = [SensorConfig("realsense_front_left", "realsense")]
            if self.three_camera_mode:
                sensors.extend([
                    SensorConfig("realsense_front_right", "realsense"),
                    SensorConfig("realsense_top", "realsense"),
